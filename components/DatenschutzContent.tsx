      ...
      <div className="max-w-3xl mx-auto px-6 lg:px-10 pt-24 lg:pt-32 pb-16">
        ...
        >
          ...
          <div>
            ...
            <p>
              Diese Website wird bei Vercel Inc. (San Francisco, CA, USA) gehostet.
              Der Hoster erhebt in sogenannten Logfiles folgende Daten, die Ihr
              Browser &uuml;bermittelt: IP-Adresse, Datum und Uhrzeit der Anfrage,
              Zeitzonendifferenz zur Greenwich Mean Time (GMT), Inhalt der
              Anforderung, HTTP-Statuscode, &uuml;bertragene Datenmenge, Website, von
              der die Anforderung kommt, Browser, Betriebssystem und dessen
              Oberfl&auml;che.
            </p>
            <p>
